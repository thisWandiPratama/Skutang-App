...
class HomePiutang extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            is_modal: false
    ...
    renderData = () => {
        ...
        return data.map((value, index) => {
            return (
                ...
                >
                    <TouchableOpacity onPress={() => this.props.navigation.navigate("DetailPiutang")} style={{ height: 45, width: "80%", justifyContent: 'center' }} >
