...
class DetailHutang extends React.Component {
    render() {
        return (
            ...
            <View style={{ flex: 1, backgroundColor: "#51C9FA", }}>
                <View style={{ backgroundColor: "#A6EFF9", height: 50, width: "100%", flexDirection: "row", alignItems: 'center' }} >
                    ...
                    <Text style={{ fontWeight: "bold", fontSize: 15, color: "#000" }}>Detail Hutang</Text>
                </View>
                    ...
                    <View style={{ width: "90%", alignItems: "center", height: "90%" }}>
                        <View style={{
                            ...
                            <View style={{ height: 30, margin: 10, marginBottom: 5, flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                                <Text style={{ color: "#000", fontWeight: "bold", fontSize: 14 }}>Hutang 1</Text>
                        ...
                        <TouchableOpacity style={{
                            ...
                            <Text style={{ color: "#FE0202", fontSize: 14, fontWeight: "bold" }}>Tagih Lewat Whatsapp</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{
