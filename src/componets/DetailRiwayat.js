...
class DetailRiwayat extends React.Component {
    render() {
        return (
            ...
            <View style={{ flex: 1, backgroundColor: "#51C9FA", }}>
                <View style={{ backgroundColor: "#A6EFF9", height: 50, width: "100%", flexDirection: "row", alignItems: 'center' }} >
                    ...
                    <Text style={{ fontWeight: "bold", fontSize: 15, color: "#000" }}>Detail Riwayat</Text>
                </View>
                <View style={{ alignItems: 'center', }}>
                    <View style={{ width: "90%", alignItems: "center", height: "90%" }}>
                        ...
                        <View style={{
                            ...
                            <Text style={{ color: "#000", fontSize: 16, fontWeight: "bold" }}> Sudah Lunas</Text>
                        </View>
                    </View>
                </View>
            </View>
